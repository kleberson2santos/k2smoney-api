package com.example.k2smoney.api.config.property;

import org.springframework.boot.context.properties.ConfigurationProperties;

import java.util.List;

@ConfigurationProperties("k2smoney")
public class K2smoneyApiProperty {
	...
	public static class S3 {
		...
		private String bucket = "k2sworks-k2smoney-arquivos";
